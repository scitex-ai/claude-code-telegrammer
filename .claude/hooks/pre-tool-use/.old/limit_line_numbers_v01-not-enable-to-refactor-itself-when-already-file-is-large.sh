#!/bin/bash
# -*- coding: utf-8 -*-
# Timestamp: "2026-04-09 12:10:01 (ywatanabe)"
# File: .//home/ywatanabe/.claude/hooks/pre-tool-use/limit_line_numbers_v01-not-enable-to-refactor-itself-when-already-file-is-large.sh
